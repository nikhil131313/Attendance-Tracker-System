                ...
                if(currdate.equals("nothing"))
                    ...
                    if (ckeckforlefthour()) {
                        ...
                        if (mydb.checkattendance(mark_subject, mark_date) && mydb.checkleave(mark_subject, mark_date)) {
                            ...
                            if (ch)
                                StyleableToast.makeText(Attendance.this, "Attendance cancelled Successfully...", R.style.exampleToast).show();
                            else {
                                StyleableToast.makeText(Attendance.this, "Attendance Not cancelled...", R.style.exampleToast).show();
                            }
                        } else
                            StyleableToast.makeText(Attendance.this, "Attendance Already Marked...", R.style.exampleToast).show();
                    }
